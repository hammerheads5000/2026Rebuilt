...
public class ModuleIOTalonFX implements ModuleIO {
    ...
    public ModuleIOTalonFX(
        ...
        driveConfig.Feedback.VelocityFilterTimeConstant = 0.005;
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        // Refresh all signals
        boolean driveStatus = BaseStatusSignal.isAllGood(
                drivePosition, driveVelocity, driveAppliedVolts, driveCurrent, driveSupplyCurrent);
        boolean turnStatus = BaseStatusSignal.isAllGood(
    ...
    public void setDriveVelocity(double velocityRadPerSec) {
        setDriveVelocity(velocityRadPerSec, 0);
    }

    @Override
    public void setDriveVelocity(double velocityRadPerSec, double driveFFAmps) {
